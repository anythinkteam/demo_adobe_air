...
#target list
EXPORT_TARGETS_LIST = ['UpArpuAdapterTiktok']
...
def buildSDKTarget(archType):
    ...
    exportCmd = "xcodebuild only_active_arch=no defines_module=yes SKIP_INSTALL=YES CODE_SIGNING_REQUIRED=NO -project UpArpuAneTTAdapter.xcodeproj clean build"
