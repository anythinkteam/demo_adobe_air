...
#target list
EXPORT_TARGETS_LIST = ['ATAdapterTiktok']
...
def buildSDKTarget(archType):
    ...
    exportCmd = "xcodebuild only_active_arch=no defines_module=yes SKIP_INSTALL=YES CODE_SIGNING_REQUIRED=NO -project ATAneTTAdapter.xcodeproj clean build"
