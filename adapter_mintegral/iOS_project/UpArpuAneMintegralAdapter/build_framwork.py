...
#target list
EXPORT_TARGETS_LIST = ['UpArpuAdapterMintegral']
...
def buildSDKTarget(archType):
    ...
    exportCmd = "xcodebuild only_active_arch=no defines_module=yes SKIP_INSTALL=YES CODE_SIGNING_REQUIRED=NO -project UpArpuAneMintegralAdapter.xcodeproj clean build"
