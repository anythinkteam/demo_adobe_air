...
adt -package -target ane sdk_plugin_okio.ane extension.xml -swc sdk_ane_adapter.swc -platform default -C default/ . -platform Android-ARM -C android/ . -platform Android-x86 -C android/ .