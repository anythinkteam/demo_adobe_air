...
#target list
EXPORT_TARGETS_LIST = ['UpArpuAdapterIronsource']
...
def buildSDKTarget(archType):
    ...
    exportCmd = "xcodebuild only_active_arch=no defines_module=yes SKIP_INSTALL=YES CODE_SIGNING_REQUIRED=NO -project UpArpuAneIronsourceAdapter.xcodeproj clean build"
